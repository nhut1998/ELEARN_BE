...
using DecentralizedSystem.Models;
using DecentralizedSystem.Models.Account;
using DecentralizedSystem.Models.SOA;
...
using static DecentralizedSystem.Models.SOA.CheckAccountCoreBankModel;
using static DecentralizedSystem.Models.SOA.RetrieveCustomerRefDataMgmtModel;
using static DecentralizedSystem.Models.SOA.SelectCustomerRefDataMgmtCIFNumModel;
using static DecentralizedSystem.Models.SOA.SelectDirectSellerTypeOfBranchModel;
using static DecentralizedSystem.Models.SOA.SelectBookAccModel;
using static DecentralizedSystem.Models.SOA.RetreiveSerialNumberModel;
using static DecentralizedSystem.Models.SOA.RetrieveCurrentAccountCASA;
using static DecentralizedSystem.Models.SOA.SelectCurrentAccountFromCIFModel;
using static DecentralizedSystem.Models.SOA.RetrieveCoreBankAccount;

namespace DecentralizedSystem.Services.SOA
{
    public interface ISOAService
    {
        ...
        /// <param name="branchCode"></param>
        /// <returns></returns>
        Task<SelectCurrentAccountFromCIFOut> SelectCurrentAccountFromCIF(string branchCode, string cif, string ccy = "VND");
    ...
    public class SOAService : ISOAService
    {
        ...
        public async Task<SelectCurrentAccountFromCIFOut> SelectCurrentAccountFromCIF(string branchCode, string cif, string ccy)
        {
            try
            {
                var url = _config["SOA:urlSOA"];
