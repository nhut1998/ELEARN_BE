...
namespace DecentralizedSystem.Models.SOA
{
    ...
    public class AccountInfoModel
    {
        ...
        [JsonProperty("accountNumDisplayName")]
        public string AccountNumDisplayName {
            get { return $"{AccountNum} - {AccountClassCode} - {AccountTypeName}"; }
        }
